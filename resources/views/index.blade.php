...
<head>
  ...
  <title>Dinas Pemadam Kebakaran dan Penyelamatan Kota Medan</title>
  ...
  <div class="sidebar p-2 py-md-3 @@cardClass">
    <div class="container-fluid">
      ...
      <div class="main-menu flex-grow-1">
        <ul class="menu-list">
          <li class="divider py-2 lh-sm"><span class="small">Kategori</span><br> <small class="text-muted">Sistem Informasi</small></li>
          
          <li class="collapsed">
            <a class="m-link {{ request()->routeIs('admin.presensi*') ? 'active' : '' }}" data-bs-toggle="collapse" data-bs-target="#presensi" href="#">
            ...
            <!-- Menu: Sub menu ul -->
            <ul class="sub-menu collapse {{ request()->routeIs('admin.presensi.*') ? 'show' : '' }}" id="presensi">
              <li><a class="ms-link {{ request()->routeIs('Kuisioner.Pertanyaan*') ? 'active' : '' }}" href="{{ route('Kuisioner.Pertanyaan') }}">Pertanyaan</a></li>
              <li><a class="ms-link {{ request()->routeIs('Kuisioner.Response*') ? 'active' : '' }}" href="{{ route('Kuisioner.Response') }}">Response</a></li>
            </ul>
          </li>
          
          <li class="collapsed">
            <a class="m-link {{ request()->routeIs('admin.sdm*') ? 'active' : '' }}" data-bs-toggle="collapse" data-bs-target="#resource" href="#">
              <svg xmlns="http://www.w3.org/2000/svg" width="18" fill="currentColor" viewBox="0 0 16 16">
            ...
            <!-- Menu: Sub menu ul -->
            <ul class="sub-menu collapse {{ request()->routeIs('admin.sdm.*') ? 'show' : '' }}" id="resource">
              <li><a class="ms-link {{ request()->routeIs('TracerStudy.Response*') ? 'active' : '' }}" href="{{ route('TracerStudy.Response') }}">Response</a></li>
            </ul>
          </li>

          <li class="collapsed">
            <a class="m-link {{ request()->routeIs('admin.informasi*') ? 'active' : '' }}" data-bs-toggle="collapse" data-bs-target="#informasi" href="#">
              <svg xmlns="http://www.w3.org/2000/svg" width="18" fill="currentColor" viewBox="0 0 16 16">
            ...
            <!-- Menu: Sub menu ul -->
            <ul class="sub-menu collapse {{ request()->routeIs('admin.informasi.*') ? 'show' : '' }}" id="informasi">
              <li><a class="ms-link {{ request()->routeIs('Informasi.Berita*') ? 'active' : '' }}" href="{{ route('Informasi.Berita') }}">Berita</a></li>
              <li><a class="ms-link {{ request()->routeIs('Informasi.Pengumuman*') ? 'active' : '' }}" href="{{ route('Informasi.Pengumuman') }}">Pengumuman</a></li>
            </ul>
          </li>

        </ul>
        <ul class="menu-list">
          <li class="divider py-2 lh-sm"><span class="small">Pengaturan</span><br> <small class="text-muted">Sistem Informasi</small></li>
          <li>
              ...
              <div class="card shadow rounded-4 search-result slidedown">
                <div class="card-body">
                  ...
                  <div class="d-flex flex-wrap align-items-start mt-2 mb-4">
                    <a class="small rounded py-1 px-2 m-1 fw-normal bg-primary text-white" href="#">Berita</a>
                    <a class="small rounded py-1 px-2 m-1 fw-normal bg-secondary text-white" href="#">Pengumuman</a>
                    <a class="small rounded py-1 px-2 m-1 fw-normal bg-info text-white" href="app-project.html">Galeri</a>
                    <a class="small rounded py-1 px-2 m-1 fw-normal bg-dark text-white" href="app-social.html">Slider</a>
                  </div>
                </div>
              </div>
            </div>
            ...
            <li>
              <div class="dropdown morphing scale-left user-profile mx-lg-3 mx-2">
                <a class="nav-link dropdown-toggle rounded-circle after-none p-0" href="#" role="button" data-bs-toggle="dropdown">
                  <img class="avatar img-thumbnail rounded-circle shadow" src="{{ asset('assets/asset_backend/img/profile_av.png') }}" alt="">
                </a>
                <div class="dropdown-menu border-0 rounded-4 shadow p-0">
                  <div class="card border-0 w240">
                    <div class="card-body border-bottom d-flex">
                      <img class="avatar rounded-circle" src="{{ asset('assets/asset_backend/img/profile_av.png') }}" alt="">
                    ...
                    <div class="list-group m-2 mb-3">
                      ...
                      <a class="list-group-item list-group-item-action border-0" href="#"><i class="w30 fa fa-gear"></i>Settings</a>                    </div>
                        <form action="#" method="POST">
                            <!-- @csrf -->
                            <div class="d-grid gap-2">
                                <button type="submit" class="btn bg-secondary text-light text-uppercase rounded-0" type="button">Logout</button>
                            </div>
                        </form>
                  </div>
                </div>
          ...
          <div class="card fieldset border setting-mode mb-4">
            ...
            <div class="c_radio d-flex text-center">
              <label class="m-1 theme-switch" for="theme-switch">
                ...
                <span class="card p-2">
                  <img class="img-fluid" src="{{ asset('assets/asset_backend/img/dark-version.svg') }}" alt="Dark Mode" />
                </span>
              </label>
              <label class="m-1 theme-dark" for="theme-dark">
                <input type="checkbox" id="theme-dark" />
                <span class="card p-2">
                  <img class="img-fluid" src="{{ asset('assets/asset_backend/img/dark-theme.svg') }}" alt="Theme Dark Mode" />
                </span>
              </label>
              <label class="m-1 theme-high-contrast" for="theme-high-contrast">
                <input type="checkbox" id="theme-high-contrast" />
                <span class="card p-2">
                  <img class="img-fluid" src="{{ asset('assets/asset_backend/img/high-version.svg') }}" alt="High Contrast" />
                </span>
              </label>
              <label class="m-1 theme-rtl" for="theme-rtl">
                <input type="checkbox" id="theme-rtl" />
                <span class="card p-2">
                  <img class="img-fluid" src="{{ asset('assets/asset_backend/img/rtl-version.svg') }}" alt="RTL Mode!" />
                </span>
              </label>
            </div>
          </div>
          ...
          <div class="card fieldset border setting-font">
            ...
            <div class="c_radio d-flex text-center font_setting">
              <label class="m-1" for="font-opensans">
                ...
                <span class="card p-2">
                  <img class="img-fluid" src="{{ asset('assets/asset_backend/img/font-opensans.svg') }}" alt="Dark Mode" />
                </span>
              </label>
              <label class="m-1" for="font-quicksand">
                <input type="radio" name="font" id="font-quicksand" value="font-quicksand" />
                <span class="card p-2">
                  <img class="img-fluid" src="{{ asset('assets/asset_backend/img/font-quicksand.svg') }}" alt="Dark Mode" />
                </span>
              </label>
              <label class="m-1" for="font-nunito">
                <input type="radio" name="font" id="font-nunito" value="font-nunito" checked="" />
                <span class="card p-2">
                  <img class="img-fluid" src="{{ asset('assets/asset_backend/img/font-nunito.svg') }}" alt="Dark Mode" />
                </span>
              </label>
              <label class="m-1" for="font-raleway">
                <input type="radio" name="font" id="font-raleway" value="font-raleway" />
                <span class="card p-2">
                  <img class="img-fluid" src="{{ asset('assets/asset_backend/img/font-raleway.svg') }}" alt="Dark Mode" />
                </span>
              </label>
            </div>
          </div>
