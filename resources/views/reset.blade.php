...
<!-- Mirrored from mahasiswa.univ-bd.ac.id/reset by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 24 Feb 2023 04:28:37 GMT -->
...
<head>
  ...
  <link rel="icon" href="{{ asset('assets/asset_administrator/img/favicon.ico" type="image/x-icon') }}"> <!-- Favicon-->
  <title>Universitas Budi Darma : Reset Password</title>
        ...
        <div class="row g-3">
          ...
          <div class="col-lg-6 d-flex justify-content-center align-items-center">
            <div class="card shadow-sm w-100 p-4 p-md-5" style="max-width: 32rem;">
              <!-- Form -->
              <form class="row g-3" action="https://mahasiswa.univ-bd.ac.id/reset/newpassword" method="post">
                <input type="hidden" name="_token" value="BwFG36G4oGDZ6j9yhFOg7NzscgKKU9vziEoaIEv8">                <div class="col-12 text-center mb-5">
                  <img src="{{ asset('assets/asset_administrator/img/auth-password-reset.svg') }}" class="w240 mb-4" alt="" />
                  <h1>Forgot password?</h1>
                  <span>Input alamat email yang telah terdaftar pada registrasi akun mahasiswa anda.</span>
                </div>
                <div class="col-12">
                  <div class="mb-2">
                ...
                <div class="col-12">
                  <div class="mb-2">
                    <label class="form-label">NPM anda</label>
                    <input type="text" name="npm" class="form-control form-control-lg" placeholder="12345678">
                  </div>
                </div>
                <div class="col-12 text-center mt-4">
                  <input type="submit" class="btn btn-lg btn-block btn-dark lift text-uppercase" value="SUBMIT">
                </div>
                <div class="col-12 text-center mt-4">
          ...
          <div class="card fieldset border setting-mode mb-4">
            ...
            <div class="c_radio d-flex text-center">
              <label class="m-1 theme-switch" for="theme-switch">
                ...
                <span class="card p-2">
                  <img class="img-fluid" src="{{ asset('assets/asset_administrator/img/dark-version.svg') }}" alt="Dark Mode" />
                </span>
              </label>
              <label class="m-1 theme-dark" for="theme-dark">
                <input type="checkbox" id="theme-dark" />
                <span class="card p-2">
                  <img class="img-fluid" src="{{ asset('assets/asset_administrator/img/dark-theme.svg') }}" alt="Theme Dark Mode" />
                </span>
              </label>
              <label class="m-1 theme-high-contrast" for="theme-high-contrast">
                <input type="checkbox" id="theme-high-contrast" />
                <span class="card p-2">
                  <img class="img-fluid" src="{{ asset('assets/asset_administrator/img/high-version.svg') }}" alt="High Contrast" />
                </span>
              </label>
              <label class="m-1 theme-rtl" for="theme-rtl">
                <input type="checkbox" id="theme-rtl" />
                <span class="card p-2">
                  <img class="img-fluid" src="{{ asset('assets/asset_administrator/img/rtl-version.svg') }}" alt="RTL Mode!" />
                </span>
              </label>
            </div>
          </div>
          ...
          <div class="card fieldset border setting-font">
            ...
            <div class="c_radio d-flex text-center font_setting">
              <label class="m-1" for="font-opensans">
                ...
                <span class="card p-2">
                  <img class="img-fluid" src="{{ asset('assets/asset_administrator/img/font-opensans.svg') }}" alt="Dark Mode" />
                </span>
              </label>
              <label class="m-1" for="font-quicksand">
                <input type="radio" name="font" id="font-quicksand" value="font-quicksand" />
                <span class="card p-2">
                  <img class="img-fluid" src="{{ asset('assets/asset_administrator/img/font-quicksand.svg') }}" alt="Dark Mode" />
                </span>
              </label>
              <label class="m-1" for="font-nunito">
                <input type="radio" name="font" id="font-nunito" value="font-nunito" checked="" />
                <span class="card p-2">
                  <img class="img-fluid" src="{{ asset('assets/asset_administrator/img/font-nunito.svg') }}" alt="Dark Mode" />
                </span>
              </label>
              <label class="m-1" for="font-raleway">
                <input type="radio" name="font" id="font-raleway" value="font-raleway" />
                <span class="card p-2">
                  <img class="img-fluid" src="{{ asset('assets/asset_administrator/img/font-raleway.svg') }}" alt="Dark Mode" />
                </span>
              </label>
            </div>
          </div>
              ...
              <li class="list-group-item setting-img">
                ...
                <div class="bg-images">
                  <ul class="list-unstyled d-flex">
                    <li class="sidebar-img-1 me-1 sidebar-img-active"><a class="rounded sidebar-img" id="img-1" href="#"><img src="{{ asset('assets/img/sidebar-bg/sidebar-1.html') }}" alt="" /></a></li>
                    <li class="sidebar-img-2 me-1"><a class="rounded sidebar-img" id="img-2" href="#"><img src="{{ asset('assets/img/sidebar-bg/sidebar-2.html') }}" alt="" /></a></li>
                    <li class="sidebar-img-3 me-1"><a class="rounded sidebar-img" id="img-3" href="#"><img src="{{ asset('assets/img/sidebar-bg/sidebar-3.html') }}" alt="" /></a></li>
                    <li class="sidebar-img-4 me-1"><a class="rounded sidebar-img" id="img-4" href="#"><img src="{{ asset('assets/img/sidebar-bg/sidebar-4.html') }}" alt="" /></a></li>
                    <li class="sidebar-img-5 me-1"><a class="rounded sidebar-img" id="img-5" href="#"><img src="{{ asset('assets/img/sidebar-bg/sidebar-5.html') }}" alt="" /></a></li>
                  </ul>
                </div>
              </li>
...
<!-- Mirrored from mahasiswa.univ-bd.ac.id/reset by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 24 Feb 2023 04:28:38 GMT -->
</html>