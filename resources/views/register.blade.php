...
<!-- Mirrored from mahasiswa.univ-bd.ac.id/register by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 24 Feb 2023 04:28:38 GMT -->
...
<head>
  ...
  <title>Universitas Budi Darma : Register</title>
        ...
        <div class="row g-3">
          ...
          <div class="col-lg-6 d-flex justify-content-center align-items-center">
            <div class="card shadow-sm w-100 p-4 p-md-5" style="max-width: 32rem;">
              <!-- Form -->
              <form class="row g-3" method="POST" action="{{ url('register_action') }}" >
              @csrf
                <div class="col-12 text-center mb-5">
                  <h1>Create account</h1>
                  <span>Portal Mahasiswa Universitas Budi Darma</span>
                </div>
                <div class="col-6">
                  <label class="form-label">Nama Lengkap</label>
                  <input type="text" name="name" class="form-control form-control-lg" placeholder="mamang racing">
                </div>
                <div class="col-6">
                  <label class="form-label">NPM</label>
                  <input type="text" name="npm" class="form-control form-control-lg" placeholder="cth: 20xxxxxx">
                </div>
                <div class="col-12">
                ...
                <div class="col-12">
                  ...
                  <input type="password" name="re-password" class="form-control form-control-lg" placeholder="8+ characters required">
                </div>
